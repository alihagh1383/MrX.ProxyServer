...
public class SessionEventArgs : EventArgs
{
    ...
    public ReadFromStream clientStreamReader { get; set; }
    ...
    public  string DecompressGzip(Stream input, Encoding e)
    {
        using (System.IO.Compression.GZipStream decompressor =
    ...
    {
        using (Ionic.Zlib.DeflateStream decompressor =
               new Ionic.Zlib.DeflateStream(input, Ionic.Zlib.CompressionMode.Decompress))
        {
            int read = 0;
            var buffer = new byte[BUFFER_SIZE];
    ...
    {
        using (Ionic.Zlib.ZlibStream decompressor =
